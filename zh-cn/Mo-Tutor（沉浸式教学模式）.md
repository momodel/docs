...
![image.png](https://imgbed.momodel.cn/card/课程更新.png)<br />点击课程图片，进入课程介绍页，此页可查看该课程介绍、课程目录、课程评价、评分，还可进入讨论群进行交流。

![image.png](https://imgbed.momodel.cn/card/课程介绍页.png)点击「加入课程」即可开始学习
...
还有其他不明白的操作？如果您对本平台课程有任何建议可以在右侧【帮助】中通过官方微信把您的想法告诉我们。<br />![iShot2022-06-10_18.32.12.png](https://imgbed.momodel.cn/card/反馈小Mo.png)
