...
![](../media/entrance-web.png)

**课程兑换指引**

1. 进入课程兑换页后，点击兑换。
   
![](../media/redeem%20page-web.png)

2. 上传课程订单信息截图，截图上传成功后点击下一步。
注意：截图应包括订单号，时间和课程名，并只能上传 jpg 和 png 格式的图片！（如何获取截图？）

 <img src="../media/redemption%20step%201.png" height="337" />  <img src="../media/redemption%20step%202.png" height="337" />

3. 填写截图上的课程订单号并选择对应课程，填写无误后才可以点击兑换。

<img src="../media/redemption%20step%203.png" height="337" />

4. 出现兑换成功提示后，就可以前去学习加入的课程了。

<img src="../media/redemption%20step%204.png" height="337" />
...
<img src="../media/entrance-wechat.png" height="435" />    <img src="../media/entrance-h5.png" height="435" />

**课程兑换指引**

1. 进入课程兑换页后，点立即兑换。

<img src="../media/redemption%20step%201-mobile.png" height="435" />

2. 上传课程订单信息截图，截图上传成功后点击下一步。
注意：截图应包括订单号，时间和课程名，并只能上传 jpg 和 png 格式的图片！（如何获取截图？）

<img src="../media/redemption%20step%201-mobile.png" height="435" />    <img src="../media/redemption%20step%202-mobile.png" height="435" />

3. 填写截图上的课程订单号并选择对应课程，填写无误后才可以点击兑换。

<img src="../media/redemption%20step%203-mobile.png" height="435" />

4. 出现兑换成功提示后，就可以前去电脑端 momodel.cn 学习加入的课程了。

<img src="../media/redemption%20step%204-mobile.png" height="435" />
...
![](../media/bilibili%20screenshot-web.png)

- 手机端：进入 bilibili 手机应用，点击右上角的，找到哔哩哔哩课堂给你发的消息，里面可以看到课程购买成功的通知。例图如下：

<img src="../media/bilibili%20screenshot-mobile.png" height="435" />

**CSDN 课程订单截图获取: **

- 电脑端：在顶部栏点击头像，找到并点击我的订单，在我的订单中可以找到课程购买的订单信息。例图如下：

![](../media/csdn%20screenshot-web.png)
