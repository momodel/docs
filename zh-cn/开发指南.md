...
<img src="https://ws4.sinaimg.cn/large/006tNbRwly1fxfucc6g3jj30m409ujrz.jpg" alt="job" width="50%"/>
...
<img src="https://ws1.sinaimg.cn/large/006tNbRwly1fxg1795o4lj30nu0gyabi.jpg" alt="job" width="50%"/>

**重要tips: 任务运行中需要保存下来的数据, 请存到 `/home/work/jovyan/results/` 路径中 (也就是左侧文件浏览器根目录下的 results 文件夹), 这个目录是任务的独立环境和Notebook环境的共享通道** 
...
<img src="https://ws4.sinaimg.cn/large/006tNbRwly1fxg18idi84j30hs160dm1.jpg" alt="job" width="50%"/>
<img src="https://ws2.sinaimg.cn/large/006tNbRwly1fxg19clsflj31if0u07ct.jpg" alt="job" width="50%"/>

##### 2.2.2 任务状态

Notebook 中的任务状态是通过图标来显示的, 下面的几个图标依次对应: 等待 (pending), 运行中 (running), 成功完成 (success), 手动中断 (terminated) 以及运行失败 (failed)

<img src="https://ws2.sinaimg.cn/large/006tNbRwly1fxg1qts6fvj302s030mx2.jpg" alt="job" width="40px"/>
<img src="https://ws3.sinaimg.cn/large/006tNbRwly1fxg1n0q91nj302y032wed.jpg" alt="job" width="40px"/>
<img src="https://ws2.sinaimg.cn/large/006tNbRwly1fxg1khoo7nj303s03smx3.jpg" alt="job" width="40px"/>
<img src="https://ws3.sinaimg.cn/large/006tNbRwly1fxg1l7t1gyj303s03o3yh.jpg" alt="job" width="40px"/>
<img src="https://ws1.sinaimg.cn/large/006tNbRwly1fxg1pjp23tj303s03qq2v.jpg" alt="job" width="40px"/>

##### 2.2.3 通知

任务运行的成功与失败, 都会有系统通知进行提醒

<img src="https://ws3.sinaimg.cn/large/006tNbRwly1fxg1er675bj30oc09qjsi.jpg" alt="job"/>
<img src="https://ws3.sinaimg.cn/large/006tNbRwly1fxg1ptu81tj30nm08wgmq.jpg" alt="job"/>
...
<img src="https://ws1.sinaimg.cn/large/006tNbRwly1fxg1cw4k9ej30g00cgq3q.jpg" alt="job"/>

对于已经结束的任务, 你可以点击 Restart 按钮重新运行 (注意: 每个任务的运行环境仅保存自运行结束起7天, 因此7天后的任务将无法被重新运行)

<img src="https://ws1.sinaimg.cn/large/006tNbRwly1fxg1ab1yklj30g00cm759.jpg" alt="job"/>
...
<img src='https://ws2.sinaimg.cn/large/006tNbRwly1fw7m42q70gj31kw0v2jtw.jpg'  width=400px>
</div>
...
<div style="border: 1px solid #eeeeee;">
<img src='https://ws4.sinaimg.cn/large/006tNc79gy1fvqj56xwwnj30ik07k0tc.jpg'  width=400px>
</div>

您也会在消息中心收到通知，通过点击可以进入到个人模块（module）的任务（job）页面，这里也有详细的任务展示，还可以通过任务（job）信息查看训练过程。

<div style="border: 1px solid #eeeeee;">
<img src='https://ws4.sinaimg.cn/large/006tNbRwly1fw7mi5bufyj31kw0yaq6q.jpg'  width=400px>
</div>
...
<div style="border: 1px solid #eeeeee;">
<img src='https://ws3.sinaimg.cn/large/006tNbRwly1fw7lid8avwj30kg0jwgmk.jpg'  width=400px>
</div>

##### 1.3.2 绿色标识代表该数据集有已完成的`crowdsourcing`任务。

<div style="border: 1px solid #eeeeee;">
<img src='https://ws3.sinaimg.cn/large/006tNbRwgy1fw8y7xblgij30ct0ch0sl.jpg'  width=400px>
</div>
...
<div style="border: 1px solid #eeeeee;">
<img src='https://ws1.sinaimg.cn/large/006tNbRwly1fw93vedbpsj31kw0skgws.jpg'  width=400px>
</div>

##### 1.3.4 进行中

<div style="border: 1px solid #eeeeee;">
<img src='https://ws2.sinaimg.cn/large/006tNbRwly1fw93k3rarbj31gc0uwgv0.jpg'  width=400px>
</div>

##### 1.3.5 已完成

<div style="border: 1px solid #eeeeee;">
<img src='https://ws1.sinaimg.cn/large/006tNbRwly1fw8pm2avo5j31kw110agn.jpg'  width=400px>
</div>
...
<div style="border: 1px solid #eeeeee;">
<img src='https://ws1.sinaimg.cn/large/006tNbRwly1fw96bm49tzj31ia0q8q7v.jpg'  width=400px>
</div>

点击`完成(Finish)`会有一次确认操作，如果每个样本没有被全部标记，那么该任务不可以被重新唤醒。

<div style="border: 1px solid #eeeeee;">
<img src='https://ws1.sinaimg.cn/large/006tNbRwly1fw7mej32x6j31kw0zmdjt.jpg'  width=400px>
</div>
...
<div style="border: 1px solid #eeeeee;">
<img src='https://ws3.sinaimg.cn/large/006tNbRwgy1fw8x6zy8w3j31kw0ou7hy.jpg'  width=400px>
</div>
...
<div style="border: 1px solid #eeeeee;">
<img src='https://ws2.sinaimg.cn/large/006tNbRwgy1fw8x2aqz08j31kw0x0wla.jpg'  width=400px>
</div>
