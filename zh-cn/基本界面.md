...
点击某个项目，即进入项目详情页面。在详情页面上方点击省略号选择相应功能可将项目复制到本地、编辑或删除；可以在页面下方查看项目概览、任务与评论，也可对已部署的项目进行试用或修改项目概览。点击“开始开发（Go Coding）”进入工作区（Notebook），工作区使用参考开发指南。

![Workspace detail](https://ws2.sinaimg.cn/large/006tNbRwgy1fw20yaedqkj31kw0urqpn.jpg)
