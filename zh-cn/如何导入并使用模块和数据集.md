...
### 1. 搜索并导入 Kaggle 数据集
点击 Notebook 左侧栏的数据集图标，切换到  标签。<br />![](https://cdn.nlark.com/yuque/0/2019/png/307794/1556429946315-f66e1763-f461-4e64-8a1b-6b54b3607221.png#align=left&display=inline&height=652&originHeight=1224&originWidth=678&size=0&status=done&width=361)             
...
- 在  标签能够查看你的挂载记录。你可以移除已导入的文件。点击查看文件可以打开该数据的文件列表。<br />![](https://cdn.nlark.com/yuque/0/2019/png/307794/1556429947446-56c60f64-e4a6-40c8-9748-ca063d6c235d.png#align=left&display=inline&height=764&originHeight=764&originWidth=814&size=0&status=done&width=814)
- 在  标签能够分别查看你收藏的 Mo 平台数据集和 Kaggle 数据集，也能取消收藏或取消导入。
- 在  标签能够查看你创建的的数据集，你能在这里将数据集导入到作品里。
## 4. 调用他人发布公开的模块
