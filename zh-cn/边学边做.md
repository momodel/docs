...
### 1. 简介
你已经学习了[开发一个工具模块(Module-Toolkit)](https://momodel.github.io/docs/#/zh-cn/%E8%BE%B9%E5%AD%A6%E8%BE%B9%E5%81%9A?id=%E5%BC%80%E5%8F%91%E4%B8%80%E4%B8%AA%E5%B7%A5%E5%85%B7%E6%A8%A1%E5%9D%97module-toolkit)的教程，`模型模块(Module-Model)`是可以供开发者二次训练的模块。本部分以SKlearn中的kmeans聚类算法为例指引你在Mo平台上开发部署一个可二次训练的模块(Module-Model)。你可以通过新建模块项目，选择从模版中创建和复制该项目，打开工程中的 Notebook 依次运行其中的Cell代码，完成相应的操作。
