...
<img src='https://ws1.sinaimg.cn/large/006tNbRwly1fy2wzp9bedj30ie0skdj5.jpg' width=30% height=30%>
然后整理插入的代码，本教程以sklearn中的kmeans聚类算法为例，这里需要注意修改以下代码中类的名称。

4.2 准备部署文件
点击第二步中的 start 按钮，开始准备部署文件。

<img src='https://ws2.sinaimg.cn/large/006tNbRwly1fy2y3hbffpj30ig0sggp7.jpg' width=30% height=30%>
...
<img src='https://ws3.sinaimg.cn/large/006tNbRwly1fy2yf4f2uzj30ig0siq6h.jpg' width=30% height=30%>
