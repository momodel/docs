...
在工作区新建数据集，创建完成后，将进入到上传编辑页面，在这里，你可以上传、删除和解压缩文件。
...
在 Mo 的 Notebook 中， 我们可以轻松的在我们自己的代码中， 插入别人已经编写好的模块 (我们也称之为 Module )。  有的模块( Module )有的是模型，可以进行二次训练，有的只是一些工具，不能二次训练。我们先看看如何插入一个不能二次训练的模块。
...
首先选择需要部署的代码，handle 函数和新建 Notebook 生成的代码必须选择。
<img src='https://ws3.sinaimg.cn/large/006tKfTcgy1g0jm27ofa5j319u0u0th6.jpg' width=100% height=100%>

然后预览生成的代码，如果有误可以点击上一步重新选择。
<img src='https://ws2.sinaimg.cn/large/006tKfTcgy1g0jm278nzcj31a30u011z.jpg' width=100% height=100%>

接下来定义输入输出参数。
<img src='https://ws2.sinaimg.cn/large/006tKfTcgy1g0jm26se7bj319n0u0439.jpg' width=100% height=100%>

最后预览生成的 YML 配置文件。
<img src='https://ws4.sinaimg.cn/large/006tKfTcgy1g0jm26biikj319t0u0n23.jpg' width=100% height=100%>

还可以查看，其他用户在调用该项目时的参数界面。
<img src='https://ws3.sinaimg.cn/large/006tKfTcgy1g0jm25welej319i0u0juw.jpg' width=100% height=100%>
