!(function () {
    ...
    D = (function t(e) {
      ...
      function L(e) {
        (pe && pe === e) ||
          ...
          (ce =
            "ADD_URI_SAFE_ATTR" in e ? ze(Pe(ue), e.ADD_URI_SAFE_ATTR) : ue),
      ...
      function be(e) {
        ...
        for (ge("beforeSanitizeShadowDOM", e, null); (t = n.nextNode()); )
          ge("uponSanitizeShadowNode", t, null),
            me(t) || (t.content instanceof p && be(t.content), ye(t));
      ...
      return (
        (d.sanitize = function (e, t) {
          ...
          if (
            ...
            1 ===
              (r = (n = F("\x3c!--\x3e")).ownerDocument.importNode(e, !0))
          ...
          if (J) {
            if (ee)
              for (o = S.call(n.ownerDocument); n.firstChild; )
      ...
      if (t) {
        ...
        if (
          ...
          var d = n.clientHeight,
            ...
            f = h - 0 < d,
            g =
              a.offsetTop >= i.scrollTop && h <= i.scrollTop + d
                ? i.scrollTop
                : f
                ? 0
                : h - d;
      ...
      function l(e) {
        (this.tokens = []),
          ...
          this.options.pedantic
            ...
            : this.options.gfm && (this.rules = b.gfm);
      }
      (b._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/),
        (b._title = /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/),
        (b.def = e(b.def)
          ...
          for (e = e.replace(/^ +$/gm, ""); e; )
            if (
              ...
              for (d = 0; d < s.cells.length; d++)
                s.cells[d] = x(s.cells[d], s.header.length);
              this.tokens.push(s);
        ...
        (u.prototype.output = function (e) {
          for (var t, n, r, i, a, o, s = ""; e; )
            if ((a = this.rules.escape.exec(e)))
              (e = e.substring(a[0].length)), (s += k(a[1]));
              ...
              (e = e.substring(a[0].length)), (s += this.renderer.br());
        ...
        (c.prototype.tok = function () {
          switch (this.token.type) {
            ...
            case "list_start":
              a = "";
              for (
                var o = this.token.ordered, s = this.token.start;
    ...
    vt = at(function (e) {
      var c = (function (c) {
          ...
          F = {
            ...
            highlightAllUnder: function (e, t, n) {
              ...
              for (var i, a = 0; (i = r.elements[a++]); )
                F.highlightElement(i, !0 === t, r.callback);
            },
            highlightElement: function (e, t, n) {
              ...
              if ((F.hooks.run("before-sanity-check", o), !o.code))
                return (
                  F.hooks.run("complete", o), void (n && n.call(o.element))
                );
                      ...
                      if (!(b instanceof O)) {
                        ...
                        if (S) {
                          ...
                          if (
                            ...
                            1 != T &&
                              F.matchGrammar(e, t, n, v, y, !0, s + "," + c),
                            a)
                          )
                            break;
                        } else if (a) break;
                ...
                c.addEventListener(
                  ...
                  function (e) {
                    var t = JSON.parse(e.data),
                      ...
                      r = t.code,
                      i = t.immediateClose;
                    c.postMessage(F.highlight(r, F.languages[n], n)),
                      i && c.close();
                  },
                  !1
                )),
        ...
        if (
          (e &&
            ((F.filename = e.src),
            e.hasAttribute("data-manual") && (F.manual = !0)),
          !F.manual)
        ) {
          function n() {
        ...
        value: function (r, i, e, a) {
          if (r.language === i) {
            ...
            (r.code = r.code.replace(e, function (e) {
              ...
              for (var t, n = o.length; -1 !== r.code.indexOf((t = yt(i, n))); )
                ++n;
              return (o[n] = e), t;
            })),
  ...
  var bt = {},
    ...
    xt = function (i, e) {
      ...
      (o = r(n)
        ? n(ot, t)
        : (ot.setOptions(h(n, { renderer: h(t, n.renderer) })), ot)),
        (this._marked = o),
  ...
  function Pt(t, n, r, i, a, e) {
    (t = e ? t : t.replace(/\/$/, "")),
      (t = ee(t)) &&
        I(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(
          i,
          function (e) {
            return Pt(t, n, r, i, a);
          }
    ...
    (e.config = S(e)),
      ...
      (function (t) {
        var e,
          n = t.config;
        (e =
          "history" === (n.routerMode || "hash") && i ? new $t(n) : new Ot(n)),
          (t.router = e),
          Nt(t),
          (Mt = t.route),
        ...
        o.isHTML
          ...
          : At({ compiler: o.compiler, raw: e }, function (e) {
              (n = o.compiler.compile(e)),
                (n = o.isRemoteUrl ? D.sanitize(n) : n),
                t(),
                a();
            });
      });
