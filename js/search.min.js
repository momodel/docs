!(function () {
      ...
      if (
        ...
        (a.forEach(function (e) {
          ...
          if (
            ...
            var i,
              o = 0;
            (o = 0 == (i = r < 11 ? 0 : r - 10) ? 70 : r + e.length + 60),
              l && o > l.length && (o = l.length);
            var a =
              "..." +
              p(l)
                .substring(i, o)
        ...
        var r = { title: p(d), content: l ? c : "", url: t, score: s };
        i.push(r);
      }
    }
  ...
  function o(t, r) {
    ...
    a.forEach(function (n) {
      if (d[n]) return c++;
      Docsify.get(r.router.getFile(n), !1, r.config.requestHeaders).then(
        function (e) {
          (d[n] = u(n, e, r.router, t.depth)),
            s === ++c &&
              (function (e, n, t) {
  ...
  function i(e) {
    ...
    if (!e)
      return (
        ...
        (t.innerHTML = ""),
        void (
          f.hideOtherSidebarContent &&
          (i.classList.remove("hide"), o.classList.remove("hide"))
        )
      );
    var a = c(e),
      s = "";
  ...
  $docsify.plugins = [].concat(function (e, n) {
    ...
    Array.isArray(r)
      ? (g.paths = r)
      : "object" == typeof r &&
        ((g.paths = Array.isArray(r.paths) ? r.paths : "auto"),
        (g.maxAge = t.isPrimitive(r.maxAge) ? r.maxAge : g.maxAge),
        (g.placeholder = r.placeholder || g.placeholder),
        (g.noData = r.noData || g.noData),
        (g.depth = r.depth || g.depth),
        (g.hideOtherSidebarContent =
          r.hideOtherSidebarContent || g.hideOtherSidebarContent),
        (g.namespace = r.namespace || g.namespace));
    var i = "auto" === g.paths;
